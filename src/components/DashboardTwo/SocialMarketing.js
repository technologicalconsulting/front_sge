        ...
        <div className="card-body">
          ...
          <div className="marketing-content">
            <div className="list">
              ...
              <div className="stats">
                <Icon.TrendingUp className="icon text-success" />
                50%
              </div>
            </div>

            <div className="list">
              <Icon.Instagram className="icon ins" />
              <h3>
                <Link to="">Instagram Ads</Link>
              </h3>
            ...
            <div className="list">
              <Icon.Twitter className="icon twi" />
              <h3>
                <Link to="">Twitter Ads</Link>
              </h3>
              <p>1.1k Like - 598 Shares</p>
              <div className="stats">
                <Icon.TrendingDown className="icon text-danger" />
                25%
              </div>
            </div>

            <div className="list">
              <Icon.Linkedin className="icon lin" />
              <h3>
            ...
            <div className="list">
              <Icon.Youtube className="icon ytb" />
              <h3>
