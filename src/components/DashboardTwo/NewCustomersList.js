        ...
        <div className="card-body">
          ...
          <div className="new-customer">
            <Link to="/" className="profile mr-3">
              <Image src={user1} alt="User" roundedCircle />
          ...
          <div className="new-customer">
            <Link to="/" className="profile mr-3">
              <Image src={user2} alt="User" roundedCircle />
              <span className="status online right-3 bottom"></span>
            </Link>
            <h5 className="fs-13 m-0">
              <Link to="/" className="global-color">
          ...
          <div className="new-customer">
            <Link to="/" className="profile mr-3">
              <Image src={user3} alt="User" roundedCircle />
              <span className="status online right-3 bottom"></span>
            </Link>
            <h5 className="fs-13 m-0">
              <Link to="/" className="global-color">
          ...
          <div className="new-customer">
            <Link to="/" className="profile mr-3">
              <Image src={user4} alt="User" roundedCircle />
              <span className="status online right-3 bottom"></span>
            </Link>
            <h5 className="fs-13 m-0">
              <Link to="/" className="global-color">
          ...
          <div className="new-customer">
            <Link to="/" className="profile mr-3">
              <Image src={user5} alt="User" roundedCircle />
