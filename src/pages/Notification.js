...
import { Row, Col, Breadcrumb, Image, ListGroup } from "react-bootstrap";
            ...
            <Col lg={6}>
              <div className="card mb-4">
                <div className="card-body">
                  <div className="notification-card-one d-flex">
              ...
              <div className="card mb-4">
                <div className="card-body">
                  <div className="notification-card-one d-flex">
                    <div className="img me-3 position-relative">
                      <Link to="#">
                        <Image
                          width={60}
                          height={60}
              ...
              <div className="card mb-4">
                <div className="card-body">
                  ...
                  <div className="notification-card-one d-flex mt-3">
                    <div className="img me-3">
                      <Link to="#">
                        <Image
                          width={60}
              ...
              <div className="card mb-4">
                <div className="card-body">
                  <div className="notification-card-one d-flex">
                    <div className="img position-relative me-3">
                      <Link to="#">
                        <Image
                          width={60}
                          height={60}
