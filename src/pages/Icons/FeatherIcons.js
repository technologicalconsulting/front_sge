      ...
      <div className="page-wrapper">
        ...
        >
          ...
          <Row>
            ...
            <Col sm={6} md={4} lg={3}>
              <div className="icon-preview hover-card mb-4">
                <Icon.ArrowDownRight className="icon" />
            ...
            <Col sm={6} md={4} lg={3}>
              <div className="icon-preview hover-card mb-4">
                <Icon.PhoneForwarded className="icon" />
                <span>phone-forwarded</span>
              </div>
            </Col>
            <Col sm={6} md={4} lg={3}>
              <div className="icon-preview hover-card mb-4">
                <Icon.PhoneIncoming className="icon" />
                <span>phone-incoming</span>
              </div>
            </Col>
            <Col sm={6} md={4} lg={3}>
              <div className="icon-preview hover-card mb-4">
                <Icon.PhoneMissed className="icon" />
                <span>phone-missed</span>
              </div>
            </Col>
            <Col sm={6} md={4} lg={3}>
              <div className="icon-preview hover-card mb-4">
                <Icon.PhoneOff className="icon" />
                <span>phone-off</span>
              </div>
            </Col>
            <Col sm={6} md={4} lg={3}>
              <div className="icon-preview hover-card mb-4">
                <Icon.PhoneOutgoing className="icon" />
