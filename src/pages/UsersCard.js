        ...
        >
          ...
          <Row>
            ...
            <Col md={6} lg={4}>
              <div className="single-user-card hover-card mb-4">
                <div className="p-30">
                  <Image src={user1} roundedCircle alt="User Image" />
                  <h4 className="mb-0 mt-4">Frank Martin</h4>
                  <p>Managing Director</p>
                  <div className="social-links">
                    <Link to="">
            ...
            <Col md={6} lg={4}>
              <div className="single-user-card hover-card mb-4">
                <div className="p-30">
                  <Image src={user2} roundedCircle alt="User Image" />
                  <h4 className="mb-0 mt-4">Frank Martin</h4>
                  <p>UI/UX Designer</p>
                  <div className="social-links">
                    <Link to="">
            ...
            <Col md={{ span: 6, offset: 3 }} lg={{ span: 4, offset: 0 }}>
              <div className="single-user-card hover-card mb-4">
                <div className="p-30">
                  <Image src={user3} roundedCircle alt="User Image" />
          ...
          <Row>
            ...
            <Col md={6} lg={4}>
              <div className="single-user-card hover-card mb-4">
                <div className="p-30">
                  <Image src={user1} className="bevel-style" alt="User Image" />
                  <h4 className="mb-0 mt-4">Frank Martin</h4>
                  <p>Managing Director</p>
                  <div className="social-links">
                    <Link to="">
            ...
            <Col md={6} lg={4}>
              <div className="single-user-card hover-card mb-4">
                <div className="p-30">
                  <Image src={user2} className="bevel-style" alt="User Image" />
                  <h4 className="mb-0 mt-4">Frank Martin</h4>
                  <p>UI/UX Designer</p>
                  <div className="social-links">
                    <Link to="">
            ...
            <Col md={{ span: 6, offset: 3 }} lg={{ span: 4, offset: 0 }}>
              <div className="single-user-card hover-card mb-4">
                <div className="p-30">
                  <Image src={user3} className="bevel-style" alt="User Image" />
                  <h4 className="mb-0 mt-4">John Doe</h4>
                  <p>Lead Designer</p>
                  <div className="social-links">
                    <Link to="">
