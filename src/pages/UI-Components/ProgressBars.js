              ...
              <div className="card mb-4">
                <div className="card-body">
                  ...
                  <ProgressBar className="mt-3 radius-0">
                    <ProgressBar striped variant="primary" now={25} key={1} />
                    <ProgressBar variant="secondary" now={15} key={2} />
                    <ProgressBar striped variant="success" now={10} key={3} />
                  </ProgressBar>
                  ...
                  <ProgressBar className="mt-3 radius-0">
                    ...
                    <ProgressBar striped variant="warning" now={15} key={3} />
                  </ProgressBar>
                  ...
                  <ProgressBar className="mt-3 radius-0">
                    <ProgressBar striped variant="warning" now={40} key={1} />
                    <ProgressBar variant="danger" now={35} key={2} />
