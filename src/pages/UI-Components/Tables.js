...
import { Row, Col, Breadcrumb, Table, Button, Badge } from "react-bootstrap";
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="text-center">
                          <Badge className="info">Pending</Badge>
                        </td>
                        <td className="text-center">
                          <Button variant="link text-success p-0 me-2">
                      ...
                      <tr>
                        ...
                        <td>02.03.2019</td>
                        <td className="text-center">
                          <Badge className="warning">Not Active</Badge>
                        </td>
                        <td className="text-center">
                          <Button variant="link text-success p-0 me-2">
                            <Icon.Edit2 className="icon wh-15" />
