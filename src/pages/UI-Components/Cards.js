...
// Cards Images
import img1 from "../../assets/img/cards/img1.jpg";
import img2 from "../../assets/img/cards/img2.jpg";
import img3 from "../../assets/img/cards/img3.jpg";
import img4 from "../../assets/img/cards/img4.jpg";
import img5 from "../../assets/img/cards/img5.jpg";
import img6 from "../../assets/img/cards/img6.jpg";
import card_overlay_thumb from "../../assets/img/cards/overlay-thumb-bg.jpg";
      ...
      <div className="page-wrapper">
        ...
        >
          ...
          <Row>
            <Col sm={6} lg={4} xl={4}>
              <Card className="mb-4">
                <Card.Img src={img1} className="radius-0" alt="Card Image" />
                <Card.Body>
            ...
            <Col sm={6} lg={4} xl={4}>
              <Card className="mb-4">
                ...
                <Card.Img src={img2} className="radius-0" alt="Card Image" />
              </Card>
            </Col>

            <Col sm={12} lg={4} xl={4}>
              <Card className="mb-4">
                <Card.Img src={img3} className="radius-0" alt="Card Image" />
                <Card.Body>
                  <Card.Title>Card Heading</Card.Title>
                  <Card.Text>
                    Some quick example text to build on the card title and make
          ...
          <Row>
            <Col sm={6} lg={4} xl={4}>
              <Card className="mb-4">
                ...
                <Card.Img src={img4} className="radius-0" alt="Card Image" />
            ...
            <Col sm={6} lg={4} xl={4}>
              <Card className="mb-4">
                ...
                <Card.Img src={img5} className="radius-0" alt="Card Image" />
            ...
            <Col sm={12} lg={4} xl={4}>
              <Card className="mb-4">
                ...
                <Card.Img src={img6} className="radius-0" alt="Card Image" />
