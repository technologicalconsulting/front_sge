...
import userImg1 from "../../assets/img/user/user1.jpg";
import userImg2 from "../../assets/img/user/user2.jpg";
import userImg3 from "../../assets/img/user/user3.jpg";
import userImg4 from "../../assets/img/user/user4.jpg";
import userImg5 from "../../assets/img/user/user5.jpg";
import userImg6 from "../../assets/img/user/user6.jpg";
import userImg7 from "../../assets/img/user/user7.jpg";
import userImg8 from "../../assets/img/user/user8.jpg";
                  ...
                  <Nav variant="pills" className="flex-column">
                    <Nav.Item>
                      <Nav.Link eventKey="inbox">
                        <Icon.Inbox className="icon wh-15 mt-minus-3 me-2" />
                        Inbox
                    ...
                    <Nav.Item>
                      <Nav.Link eventKey="sent">
                        <Icon.Send className="icon wh-15 mt-minus-3 me-2" />
                        Sent
                    ...
                    <Nav.Item>
                      <Nav.Link eventKey="drafts">
                        <Icon.FileText className="icon wh-15 mt-minus-3 me-2" />
                        Drafts
                    ...
                    <Nav.Item>
                      <Nav.Link eventKey="starred">
                        <Icon.Star className="icon wh-15 mt-minus-3 me-2" />
                        Starred
                        <span className="fr">(2)</span>
                      </Nav.Link>
                    </Nav.Item>
                    ...
                    <Nav.Item>
                      <Nav.Link eventKey="spam">
                        <Icon.AlertOctagon className="icon wh-15 mt-minus-3 me-2" />
                        Spam
                        <span className="fr">(2)</span>
                      </Nav.Link>
                    </Nav.Item>
                    ...
                    <Nav.Item>
                      <Nav.Link eventKey="trash">
                        <Icon.Trash2 className="icon wh-15 mt-minus-3 me-2" />
                        Trash
                        <span className="fr">(2)</span>
                      </Nav.Link>
                    </Nav.Item>
